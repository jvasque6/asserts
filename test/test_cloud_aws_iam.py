...
def test_pass_len_unsafe_open():
    ...
    assert aws_iam.min_password_len_unsafe(AWS_ACCESS_KEY_ID,
                                           AWS_SECRET_ACCESS_KEY)


def test_pass_reuse_unsafe_open():
    """Search IAM policy: Password reuse requirement."""
    assert aws_iam.password_reuse_unsafe(AWS_ACCESS_KEY_ID,
                                         AWS_SECRET_ACCESS_KEY)


def test_pass_expiration_unsafe_open():
    """Search IAM policy: Password expiration requirement."""
    assert aws_iam.password_expiration_unsafe(AWS_ACCESS_KEY_ID,
                                              AWS_SECRET_ACCESS_KEY)


def test_root_mfa_open():
    """Search IAM summary: MFA for root."""
    assert aws_iam.root_without_mfa(AWS_ACCESS_KEY_ID,
                                    AWS_SECRET_ACCESS_KEY)
...
def test_has_mfa_disabled_close():
    ...
    assert not aws_iam.has_mfa_disabled(AWS_ACCESS_KEY_ID,
                                        AWS_SECRET_ACCESS_KEY)
    assert not aws_iam.has_mfa_disabled(AWS_ACCESS_KEY_ID,
...
def test_have_old_creds_enabled_close():
    ...
    assert not aws_iam.have_old_creds_enabled(AWS_ACCESS_KEY_ID,
                                              AWS_SECRET_ACCESS_KEY)
    assert not aws_iam.have_old_creds_enabled(AWS_ACCESS_KEY_ID,
                                              AWS_SECRET_ACCESS_KEY_BAD)
...
def test_have_old_access_keys_close():
    ...
    assert not aws_iam.have_old_access_keys(AWS_ACCESS_KEY_ID,
                                            AWS_SECRET_ACCESS_KEY)
    assert not aws_iam.have_old_access_keys(AWS_ACCESS_KEY_ID,
                                            AWS_SECRET_ACCESS_KEY_BAD)
...
def test_root_has_access_keys_close():
    ...
    assert not aws_iam.root_has_access_keys(AWS_ACCESS_KEY_ID,
                                            AWS_SECRET_ACCESS_KEY)
    assert not aws_iam.root_has_access_keys(AWS_ACCESS_KEY_ID,
                                            AWS_SECRET_ACCESS_KEY_BAD)
...
def test_not_requires_uppercase_close():
    ...
    assert not aws_iam.not_requires_uppercase(AWS_ACCESS_KEY_ID,
                                              AWS_SECRET_ACCESS_KEY)
    assert not aws_iam.not_requires_uppercase(AWS_ACCESS_KEY_ID,
                                              AWS_SECRET_ACCESS_KEY_BAD)
...
def test_not_requires_lowercase_close():
    ...
    assert not aws_iam.not_requires_lowercase(AWS_ACCESS_KEY_ID,
                                              AWS_SECRET_ACCESS_KEY)
    assert not aws_iam.not_requires_lowercase(AWS_ACCESS_KEY_ID,
                                              AWS_SECRET_ACCESS_KEY_BAD)
...
def test_not_requires_symbols_close():
    ...
    assert not aws_iam.not_requires_symbols(AWS_ACCESS_KEY_ID,
                                            AWS_SECRET_ACCESS_KEY)
    assert not aws_iam.not_requires_symbols(AWS_ACCESS_KEY_ID,
                                            AWS_SECRET_ACCESS_KEY_BAD)
...
def test_not_requires_numbers_close():
    ...
    assert not aws_iam.not_requires_numbers(AWS_ACCESS_KEY_ID,
                                            AWS_SECRET_ACCESS_KEY)
    assert not aws_iam.not_requires_numbers(AWS_ACCESS_KEY_ID,
                                            AWS_SECRET_ACCESS_KEY_BAD)
...
def test_pass_len_unsafe_close():
    """Search IAM policy: Password length requirement."""
    assert not aws_iam.min_password_len_unsafe(AWS_ACCESS_KEY_ID,
                                               AWS_SECRET_ACCESS_KEY_BAD)
...
def test_pass_reuse_unsafe_close():
    """Search IAM policy: Password reuse requirement."""
    assert not aws_iam.password_reuse_unsafe(AWS_ACCESS_KEY_ID,
                                             AWS_SECRET_ACCESS_KEY_BAD)
...
def test_pass_expiration_unsafe_close():
    """Search IAM policy: Password expiration requirement."""
    assert not aws_iam.password_expiration_unsafe(AWS_ACCESS_KEY_ID,
                                                  AWS_SECRET_ACCESS_KEY_BAD)
...
def test_root_mfa_close():
    """Search IAM summary: MFA for root."""
    assert not aws_iam.root_without_mfa(AWS_ACCESS_KEY_ID,
                                        AWS_SECRET_ACCESS_KEY_BAD)
...
def test_policies_attached_close():
    ...
    assert not aws_iam.policies_attached_to_users(AWS_ACCESS_KEY_ID,
                                                  AWS_SECRET_ACCESS_KEY)
    assert not aws_iam.policies_attached_to_users(AWS_ACCESS_KEY_ID,
                                                  AWS_SECRET_ACCESS_KEY_BAD)
