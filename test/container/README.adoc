...
Y se añaden los hosts de Fluid Asserts asi:
...
Para los propositos de Fluid Asserts que es solo para pruebas y
...
para el proposito que requiere Fluid Asserts, pues como todo el trabajo
