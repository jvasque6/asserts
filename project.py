...
'''
pdf.has_author('test/vulnerable.pdf')
pdf.has_creator('test/vulnerable.pdf')
pdf.has_producer('test/vulnerable.pdf')
...
pdf.has_author('test/non-vulnerable.pdf')
pdf.has_creator('test/non-vulnerable.pdf')
pdf.has_producer('test/non-vulnerable.pdf')
